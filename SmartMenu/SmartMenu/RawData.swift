...
struct RawData {
    ...
    var lunchDinnerConstraint : TimeConstraint
    ...
    init() {
        ...
        self.lunchDinnerConstraint = TimeConstraint(calendar: calendar, startOfConstraint: 11, endOfConstraint: 20, calendarComponent : Calendar.Component.hour)
        ...
        self.foodItems = [
            ...
            Food(name: "Cheese & Tomato Crossaint", description: "Toasted crossaint with cheese and tomato", type: FoodType.light, cost: 6.50, imageData: "cheese tomato crossaint.jpg", suggestions: [], timeConstraints: [breakfastConstraint], waitTimeMinutes: 9),
            Food(name: "Ham & Cheese Crossaint", description: "Toasted crossaint with ham and cheese", type: FoodType.light, cost: 6.50, imageData: "ham and cheese crossaint.jpg", suggestions: [], timeConstraints: [breakfastConstraint], waitTimeMinutes: 9),
            ...
            Food(name: "Shoestring fries", description: "with aioli", type: FoodType.light, cost: 5, imageData: "shoestring fries.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 10),
            Food(name: "Sweet Potato Chips", description: "with aioli", type: FoodType.light, cost: 6, imageData: "sweet potato chips.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 10),
            Food(name: "Side Garden Salad", description: "with tomato, cucumber, onion and a balsamic dressing", type: FoodType.light, cost: 6, imageData: "side garden salad.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 5),
            Food(name: "Side Rocket & Parmesan Salad", description: "with tomato and a balsamic dressing", type: FoodType.light, cost: 6, imageData: "side rocket parmesan salad.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 5),
            ...
            Food(name: "Vegetarian Tasting Plate", description: "mushroom arancini with harrissa mayonaisse, pumpkin & fetta brushcetta, zuchinni fritters with tzatziki", type: FoodType.light, cost: 12, imageData: "vegetarian tasting plate.jpg", suggestions: [], timeConstraints: [lunchConstraint], waitTimeMinutes: 10),
            ...
            Food(name: "Chicken Schnitzel", description: "House-crumbed chicken breast schnitzel served with chips tomato sauce & lemon-wedge", type: FoodType.main, cost: 14, imageData: "chicken schnitzel.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 15),
            Food(name: "Chicken Parmigiana", description: "House-crumbed chicken breast schnitzel with Neapolitan sauce and cheese, with chips tomato sauce & lemon-wedge", type: FoodType.main, cost: 12, imageData: "chicken parmigiana.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 15),
            Food(name: "Prawn Fetuccini", description: "with bacon tomato and mild chilli", type: FoodType.main, cost: 15, imageData: "prawn fetuccini.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 15),
            Food(name: "Bangers & Mash", description: "two german kransky sausages with mashed potato onion and gravy", type: FoodType.main, cost: 15, imageData: "bangers mash.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 15),
            Food(name: "Angus Rump Steak", description: "200g, served with mash potato and onion gravy", type: FoodType.main, cost: 14, imageData: "angus rump steak.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 20),
            Food(name: "T-Bone Steak", description: "300g, served with mash potato and onion gravy", type: FoodType.main, cost: 15, imageData: "t-bone steak.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 20),
            Food(name: "Grilled Barramundi", description: "with tartare sauce, served with mash potato and onion gravy", type: FoodType.main, cost: 19, imageData: "grilled barramundi.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 20),
            Food(name: "Classic Cheese", description: "Wagyu beef patty with cheddar cheese, tomato, lettuce, tomato sauce and mayo", type: FoodType.main, cost: 12, imageData: "classic cheese.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 15),
            Food(name: "Grilled Chicken", description: "Grilled chicken tenderloins with tomato, lettuce, aioli and avocado salsa", type: FoodType.main, cost: 13, imageData: "grilled chicken.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 15),
            Food(name: "Fish Burger", description: "House-crumbed fish fillet with a lemon mayonnaise, cheddar cheese, tomato, lettuce and relish", type: FoodType.main, cost: 13, imageData: "fish burger.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 15),
            Food(name: "Beef & Bacon", description: "Wagyu beef patty, bacon, lettuce, tomato, cheddar cheese, pickles, aioli & tomato relish", type: FoodType.main, cost: 16, imageData: "beef bacon.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 15),
            Food(name: "Mexican Chicken", description: "Chili and lime coated chicken breast with corn salsa and avocado", type: FoodType.main, cost: 16, imageData: "mexican chicken.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 15),
            Food(name: "Pulled Mushroom", description: "Assorted mushrooms with slaw and chilli aioli", type: FoodType.main, cost: 13, imageData: "pulled mushroom.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 15),
            Food(name: "Beef Nachos", description: "with spicy salsa, guacamole, sour cream and cheese", type: FoodType.main, cost: 14, imageData: "beef nachos.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 15),
            Food(name: "Vegetarian Nachos", description: "with spicy salsa, guacamole, sour cream and cheese", type: FoodType.main, cost: 12, imageData: "vegetarian nachos.jpg", suggestions: [], timeConstraints: [lunchDinnerConstraint], waitTimeMinutes: 15),
