...
struct TestData{
    ...
    init() {
        ...
        self.foodItems = [
            ...
            Food(name: "Bacon and Egg Roll", description: "Fried egg, bacon, aioli, wild rocket and BBQ suace on a super soft milk bun", type: FoodType.light, cost: 6.50, imageData: "bacon and egg roll.jpg", suggestions: [], timeConstraints: [breakfastConstraint], waitTimeMinutes: 12),
            Food(name: "Mushroom and Egg Roll", description: "Fried eggs, suateed mushrooms, aioli,  wild rocket and BBQ suace on a super soft milk bun", type: FoodType.light, cost: 6.50, imageData: "mushroom and egg roll.jpg", suggestions: [], timeConstraints: [breakfastConstraint], waitTimeMinutes: 12),
            ...
            Food(name: "Apple & Salted Caramel Tart", description: "images (48).jpg", type: FoodType.dessert, cost: 9, imageData: "apple salted caramel tart.jpg", suggestions: [], timeConstraints: [dinnerConstraint], waitTimeMinutes: 5),
